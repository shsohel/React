          ...
          <Table size="small" className={classes.tableHeading}>
            <TableBody>
              <TableRow>
                ...
                <TableCell>
                  <mark>{recordForDetails.orderNumber}</mark>
                </TableCell>
              </TableRow>
              <TableRow>
              ...
              <TableRow>
                ...
                <TableCell>{Moment(recordForDetails.requestDateAndTime).format('DD-MMM-yyyy')}</TableCell>
                <TableCell>Confirmed Date:</TableCell>
                <TableCell>
                  {recordForDetails.confirmDateAndTime === ''
                    ? 'N/A'
                    : Moment(recordForDetails.confirmDateAndTime).format('DD-MMM-yyyy')}
                </TableCell>
              </TableRow>
            </TableBody>
          </Table>
