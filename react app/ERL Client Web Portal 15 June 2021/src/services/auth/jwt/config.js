...
const apiVersion = 1;
//export const baseURL = 'http://192.168.0.18:89';
export const baseURL = 'http://erlclientapi.nvit.info';

export const reportType = {
  INVOICE: 'print-invoice-pdf',
  ENTRY_PERMIT: 'print-entry-permit-pdf',
  DAILY_ENTRY_PERMIT_LIST: 'print-daily-entry-permit-list-pdf',
  EXIT_PERMIT: 'print-exit-permit-pdf',
  SALES_REGISTER: 'print-sale-register-pdf',
  DAILY_BITUMIN_DELIVERY: 'print-daily-delivery-pdf',
  MONTHLY_BITUMIN_DELIVERY: 'print-monthly-delivery-pdf',
  YEARLY_BITUMIN_DELIVERY: 'print-yearly-delivery-pdf',
  DAILY_LIFTING_SCHEDULE: 'lifting-schedule-pdf',
  PRICE_HISTORY: 'print-price-history-pdf'
};
...
export const urls = {
  account: {
    roles: {
      get_all: `/api/Role/get-all`,
      get_by_name: `/api/Account/roles/name`,
      get_by_Id: `/api/Account/roles`,
      post: `/api/Account/roles`,
      put: `/api/Account/roles`,
      delete: `/api/Account/roles`
    },
    permissions: {
      get_all_by_roleId: `/api/Permission`
    },
    users: {
      get_me: `/api/User/get`,
      get_all_users: `/api/User/get-all`,
      get_user_by_userId: `/api/User/get`,
      put: `/api/User`,
      post: `/api/User`,
      delete_user_by_userId: `/api/User`,
      change_password: `/api/identity/change-password`,
      password_reset_by_Admin: `/api/identity/reset-password-by-admin`,
  ...
  customer: {
    ...
    get_all_customer_name: `/api/v${apiVersion}/Customer/get-all-names`,
    get_by_key: `/api/v${apiVersion}/Customer/get-customer-info`,
    get_customer_by_Id: `/api/v${apiVersion}/Customer/get-customer`,
  ...
  entryPermit: {
    ...
    get_epName_for_invoice: `/api/v${apiVersion}/EntryPermit/get-all-entry-permits-numbers-for-invoice`,
  ...
  order: {
    get_all: `/api/V${apiVersion}/Order`,
    get_by_key: `/api/V${apiVersion}/Order/get-order`,
    get_by_id: `/api/V${apiVersion}/Order`,
    ...
    get_order_for_edit: `/api/V${apiVersion}/Order`,
    post: `/api/V${apiVersion}/Order`,
    put: `/api/V${apiVersion}/Order`,
    put_order_confirmation: `/api/V${apiVersion}/Order/order-confirmation`,
    delete: `/api/V${apiVersion}/Order`,
    delete_order_details_by_key: `/api/V${apiVersion}/Order/delete-detail`
  },

  products: {
    get_all: `/api/v${apiVersion}/Product`,
    get_by_key: `/api/v${apiVersion}/Product/get-product`,
    get_by_id: `/api/v${apiVersion}/Product`,
    get_all_products: `/api/v${apiVersion}/Product/get-all-products`,
    get_product_grade_by_productId: `/api/v${apiVersion}/Product/product-grades-by-id`,
  ...
  purchaseType: {
    ...
    get_all_purchaseType: `/api/v${apiVersion}/PurchaseType/get-all-purchase-types-name`,
  ...
  representative: {
    ...
    delete: `/api/${apiVersion}/Representative/delete-representative-info`
  },
